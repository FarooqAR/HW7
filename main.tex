...
\runningheadrule
\runningfootrule
\runningheader{CS 113 Discrete Mathematics}{Homework VII}{Spring 2018}
...
\author{$< \ >$}  % replace with your ID, e.g. ms03831
...
Using the deductive skills that you acquired in assignment#1, find out the students who cheated based on their Facebook and WhatsApp profiles along with the search history that you got from the IT department. Support your findings by constructing a proof.
  \begin{solution}
